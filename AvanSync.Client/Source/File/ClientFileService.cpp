...
const std::string ClientFileService::OK_UPLOAD = "Success: the requested entry was uploaded";
const std::string ClientFileService::OK_DOWNLOAD = "Success: the requested entry was downloaded";
